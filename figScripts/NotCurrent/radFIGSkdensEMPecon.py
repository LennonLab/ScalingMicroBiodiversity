...
radDATA1 = open('/Users/lisalocey/Desktop/RareBio/RADdataEMP.txt','r')

radDATA2 = open('/Users/lisalocey/Desktop/RareBio/RADdataECON.txt','r')
...
def kdensMetrics():
    ...
    print len(microlist), len(macrolist), len(emplist)    
    ...
    plt.plot(D[0], D[1], color = 'Gold', lw=3, alpha = 0.9,
             label = 'social-econ (n='+str(n)+')')
    ymax = max(D[1])
    plt.ylim(0.0, ymax)
    plt.ylabel("Probability density",fontsize=fs)
    plt.xlabel(metric, fontsize=fs)
...
def rarebio(plists, klist):
    ...
    for j, plist in enumerate(plists):
        ...
        ymax = max(ymax1, ymax2, ymax3, ymax4, ymax5) + 0.4*(max(ymax4, ymax1, ymax2, ymax3, ymax5))
        plt.ylim(0.0, ymax)
        xmax = xlims[j]
        plt.xlim(0.0, xmax)
...
def scatterNmax2():
    ...
    for i in metrics:
        ...
        plt.scatter(MicListX, MicListY, color = 'm', alpha = 0.5, s=5,
        ...
        plt.scatter(EMPlistX, EMPlistY, color = 'c', alpha=0.2, s=5,
                        label= 'EMP-closed (n='+str(emacs)+')\nR2='+str(r2)+' slope='+str(slope))
        ...
        plt.scatter(EMPoListX, EMPoListY, color = 'SteelBlue',alpha=0.2, s=5,
                        label= 'EMP-open (n='+str(emacsO)+')\nR2='+str(r2)+' slope='+str(slope))            
        ...
        plt.scatter(MacListX, MacListY, color = 'gray', alpha=0.3 , s=5,
                     label= 'macrobial (n='+str(nmacs)+')\nR2='+str(r2)+' slope='+str(slope))
