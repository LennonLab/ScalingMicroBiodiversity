...
def kdensMetrics():
    ...
    plt.savefig('/Users/lisalocey/Desktop/RareBio/figs/MetricsKdensEMP.png',
    dpi=600)
    plt.close()
...
def scatterMetrics():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig('/Users/lisalocey/Desktop/RareBio/figs/ScatterMetrics.png', dpi=600)
    plt.close()
...
def scatterMetricsRare():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig('/Users/lisalocey/Desktop/RareBio/figs/ScatterRare.png',
    dpi=600)
    plt.close()
...
def scatterNmax():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig('/Users/lisalocey/Desktop/RareBio/figs/ScatterMax.png',
    dpi=600)
    plt.close()
...
def MoneyFig1():
    ...
    for j in indexList:
        ...
        if klist[j] == 'm': 
            nmics += 1
            plt.scatter(Nlist[j], metlist[j], color=klist[j], alpha=0.6, s=0.5)
    ...
    for i, j in enumerate(rareSumOnesList):
        if klist[i] == 'm':
            microlist.append(j)
        elif klist[i] == 'c':
            macrolist.append(j)
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig('/Users/lisalocey/Desktop/RareBio/figs/ProjectN-Fig1.png', dpi=600)
    plt.close()
...
def MoneyFig2():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig('/Users/lisalocey/Desktop/RareBio/figs/ProjectN-FS.png', dpi=600)
    plt.close()
