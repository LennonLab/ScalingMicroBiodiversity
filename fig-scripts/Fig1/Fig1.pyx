...
def Fig1():
    ...
    datasets = []
    BadNames = ['.DS_Store', 'EMPopen', 'BCI', 'AGSOIL', 'SLUDGE', 'FECES']
    ...
    for index, i in enumerate(metrics):
        ...
        if index == 0:
            plt.ylim(-0.1, 2.0)
            plt.xlim(1, 6)
            plt.text(1.35, 1.7, r'$micro$'+ ' = '+str(round(MacInt,2))+'+'+str(round(MicCoef, 2))+'*'+r'$N$', fontsize=fs-1, color='Steelblue')
            plt.text(1.35, 1.5, r'$macro$'+ ' = '+str(round(MacInt,2))+'+'+str(round(MacCoef,2))+'*'+r'$N$', fontsize=fs-1, color='Crimson')
            plt.text(1.35, 1.2,  r'$R^2$' + '=' +str(round(r2,3)), fontsize=fs-1, color='k')
            ...
            plt.text(1.35, 5.1, r'$micro$'+ ' = '+str(round(MacInt,2))+'+'+str(round(MacCoef,2))+'*'+r'$N$', fontsize=fs-1, color='Steelblue')
            plt.text(1.35, 4.5, r'$macro$'+ ' = '+str(round(MacInt,2))+'+'+str(round(MacCoef,2))+'*'+r'$N$', fontsize=fs-1, color='Crimson')
            plt.text(1.35, 3.75,  r'$R^2$' + '=' +str(round(r2,3)), fontsize=fs-1, color='k')
            ...
            plt.text(1.35, -2.3,  r'$R^2$' + '=' +str(round(r2,3)), fontsize=fs-1, color='k')
            ...
            plt.text(1.35, 3.0,  r'$R^2$' + '=' +str(round(r2,3)), fontsize=fs-1, color='k')
    ...
    plt.savefig(mydir+'/figs/Locey_Lennon_2015_Fig1v2-Closed_NoMicrobe1s.png', dpi=600, bbox_inches = "tight")
    plt.close()
