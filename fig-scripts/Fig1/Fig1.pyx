...
def Fig1():
    ...
    plt.savefig(mydir+'/figs/Fig1/Locey_Lennon_2015_Fig1_OpenRef_NoMicrobeSingletons.png', dpi=600, bbox_inches = "tight")
    #plt.savefig(mydir+'/figs/Fig1/Locey_Lennon_2015_Fig1_OpenRef.png', dpi=600, bbox_inches = "tight")
