...
radDATA = open(mydir+'output/EMPclosed-SSAD-ResultsTable.txt','r')
...
for data in radDATA:
    ...
    N, S, Evar, ESimp, ENee, EHeip, EQ, EPielou, BP, SimpDom, rareRel, rareOnes, rarePair, rareSumOnes = data_list
...
def kdensMetrics():
    ...
    plt.savefig(mydir+'/figs/SSAD-MetricsKdensEMP.png', dpi=600)
    plt.close()
...
def scatterMetrics():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig(mydir+'/figs/SSAD-ScatterMetrics.png', dpi=600)
    plt.close()
...
def scatterMetricsRare():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig(mydir+'/figs/SSAD-ScatterRare.png', dpi=600)
    plt.close()
...
def scatterNmax():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig(mydir+'/figs/SSAD-ScatterMax.png', dpi=600)
    plt.close()
...
def scatterNmax2():
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig(mydir+'/figs/SSAD-ScatterMax2.png', dpi=600)
    plt.close()
...
def Fig1(tool):
    ...
    IN = open(mydir+'/output/macrostates/SSAD'+tool+'.txt','r')
    ...
    plt.subplots_adjust(wspace=0.4, hspace=0.4)
    plt.savefig(mydir+'/figs/SSAD-RareBio-Fig2.png', dpi=600)
    plt.close()
